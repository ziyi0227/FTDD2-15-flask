...
if __name__ == '__main__':
    ...
    #print(train_cf.shape)       # n_pair ,2
    #print(user_dict)            #dict, 存储每个用户的商品
    #print(n_params)             #{'n_users': 4440, 'n_items': 19378, 'n_entities': 19378, 'n_nodes': 23818, 'n_relations': 11}
    #print(graph)                #MultiDiGraph with 19378 nodes and 193780 edges
    ...
    for epoch in range(args.epoch):
        ...
        if epoch % 10 == 9 or epoch == 1:
            ...
            train_res.field_names = ["Epoch", "training time", "tesing time", "Loss", "recall", "ndcg", "precision", "hit_ratio", "acc"]
            train_res.add_row(
                [epoch, train_e_t - train_s_t, test_e_t - test_s_t, loss.item(), ret['recall'], ret['ndcg'], ret['precision'], ret['hit_ratio'], ret['acc']]
            )
            print(train_res)
